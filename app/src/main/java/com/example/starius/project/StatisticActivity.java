...
public class StatisticActivity extends AppCompatActivity {
    ...
    {
        final ListView listView1 = (ListView) findViewById(R.id.dateofEating);

        String url = URLs.HOST_URL + "StatisticActivity.php";  //192.168.1.103
        ...
        try {
            ...
            simpleAdapterData = new SimpleAdapter(StatisticActivity.this, MyArrList, R.layout.list_item,
